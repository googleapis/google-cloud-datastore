...
type PropertyExpression struct {
	...
	AggregationFunction *PropertyExpression_AggregationFunction `protobuf:"varint,2,opt,name=aggregation_function,enum=api.services.datastore.PropertyExpression_AggregationFunction" json:"aggregation_function,omitempty"`
	XXX_unrecognized    []byte                                  `json:"-"`
}
...
type PropertyOrder struct {
	Property         *PropertyReference       `protobuf:"bytes,1,req,name=property" json:"property,omitempty"`
	Direction        *PropertyOrder_Direction `protobuf:"varint,2,opt,name=direction,enum=api.services.datastore.PropertyOrder_Direction,def=1" json:"direction,omitempty"`
	XXX_unrecognized []byte                   `json:"-"`
}
...
type CompositeFilter struct {
	Operator         *CompositeFilter_Operator `protobuf:"varint,1,req,name=operator,enum=api.services.datastore.CompositeFilter_Operator" json:"operator,omitempty"`
...
type PropertyFilter struct {
	Property         *PropertyReference       `protobuf:"bytes,1,req,name=property" json:"property,omitempty"`
	Operator         *PropertyFilter_Operator `protobuf:"varint,2,req,name=operator,enum=api.services.datastore.PropertyFilter_Operator" json:"operator,omitempty"`
...
type QueryResultBatch struct {
	EntityResultType *EntityResult_ResultType          `protobuf:"varint,1,req,name=entity_result_type,enum=api.services.datastore.EntityResult_ResultType" json:"entity_result_type,omitempty"`
	...
	MoreResults      *QueryResultBatch_MoreResultsType `protobuf:"varint,5,req,name=more_results,enum=api.services.datastore.QueryResultBatch_MoreResultsType" json:"more_results,omitempty"`
...
type ReadOptions struct {
	ReadConsistency  *ReadOptions_ReadConsistency `protobuf:"varint,1,opt,name=read_consistency,enum=api.services.datastore.ReadOptions_ReadConsistency,def=0" json:"read_consistency,omitempty"`
...
type BeginTransactionRequest struct {
	IsolationLevel   *BeginTransactionRequest_IsolationLevel `protobuf:"varint,1,opt,name=isolation_level,enum=api.services.datastore.BeginTransactionRequest_IsolationLevel,def=0" json:"isolation_level,omitempty"`
	XXX_unrecognized []byte                                  `json:"-"`
}
...
type CommitRequest struct {
	...
	Mode             *CommitRequest_Mode `protobuf:"varint,5,opt,name=mode,enum=api.services.datastore.CommitRequest_Mode,def=1" json:"mode,omitempty"`
	XXX_unrecognized []byte              `json:"-"`
}
