...
TESTS=blobstore_test.py,context_test.py,eventloop_test.py,google_test_imports.py,key_test.py,metadata_test.py,model_test.py,msgprop_test.py,polymodel_test.py,prospective_search_test.py,query_test.py,rpc_test.py,stats_test.py,tasklets_test.py,test_utils.py
